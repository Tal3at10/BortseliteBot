...
اكتب رقم الخدمة فقط.";
        ...
        private string GetServiceFirstQuestion(int serviceNumber)
        {
            ...
            {
                1 => "✅ تم اختيار خدمة التخليص الجمركي\n\n💼 نخبة المنافذ تتولى جميع إجراءات التخليص بدقة وسرعة لضمان وصول شحنتك دون تأخير أو مخالفات.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ أرفق صورة بوليصة الشحن أو رقمها\n\n" + GetNavigationFooter(),
                2 => "✅ تم اختيار خدمة إصدار شهادة سابر\n\n💼 نقدّم خدمة إصدار شهادات سابر واعتماد المنتجات بسهولة وسرعة لضمان مطابقة بضاعتك للأنظمة السعودية دون تعقيد.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ ما نوع المنتج؟\n(يرجى ذكر النوع بشكل محدد. مثال: لمبات LED، خلاط كهربائي)\n\n" + GetNavigationFooter(),
                3 => "✅ تم اختيار خدمة الشحن الدولي\n\n💼 شبكة شحن دولية بحلول آمنة وسريعة وتكاليف تنافسية لنقل بضائعك من وإلى المملكة بكفاءة عالية.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ من أي مدينة سيتم الشحن؟\n\n" + GetNavigationFooter(),
                4 => "✅ تم اختيار خدمة التصدير\n\n💼 نوفّر خدمات تصدير متكاملة تشمل تجهيز الوثائق، التنسيق اللوجستي، وضمان وصول الشحنات إلى وجهاتها بكفاءة.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ ما نوع المنتج؟\n\n" + GetNavigationFooter(),
                5 => "✅ تم اختيار خدمة النقل المحلي\n\n💼 أسطول نقل محلي مجهّز لنقل بضائعك داخل المملكة بأمان والتزام تام بالمواعيد.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ حدد موقع الاستلام (اسم مدينة + حي)\n\n" + GetNavigationFooter(),
                6 => "✅ تم اختيار خدمة التخزين\n\n💼 مستودعات آمنة مزوّدة بأنظمة مراقبة وبيئة مناسبة لحفظ مختلف البضائع لفترات قصيرة وطويلة.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ ما نوع البضاعة؟\n\n" + GetNavigationFooter(),
                7 => "✅ تم اختيار خدمة التعبئة والتغليف\n\n💼 حلول تعبئة وتغليف احترافية تحافظ على سلامة بضاعتك أثناء النقل والتخزين مع خيارات تناسب طبيعة المنتج.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ ما نوع البضاعة؟\n\n" + GetNavigationFooter(),
                8 => "✅ تم اختيار خدمة الفعاليات والمعارض\n\n💼 خدمات متكاملة لدعم مشاركتك في المعارض والفعاليات، تشمل النقل والتجهيز والتنسيق لضمان حضور احترافي وسلس.\n\n━━━━━━━━━━━━━━━━\n📋 نحتاج منك:\n\n1️⃣ ما نوع الفعالية أو المعرض؟\n\n" + GetNavigationFooter(),
                _ => "حدث خطأ"
            };
        }
